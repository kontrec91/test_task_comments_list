...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://-webhome/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://-webhome/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://-webhome/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://-webhome/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_form_FormComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/form/FormComponent.js */ \"./src/components/form/FormComponent.js\");\n/* harmony import */ var _components_CommentsList_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/CommentsList.js */ \"./src/components/CommentsList.js\");\n/* harmony import */ var _components_showMorebutton_ShowMoreButton_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/showMorebutton/ShowMoreButton.js */ \"./src/components/showMorebutton/ShowMoreButton.js\");\n/* harmony import */ var _css_form_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./css/form.css */ \"./src/css/form.css\");\n\n\n\n\n\n\nconst commentsURL = 'https://jordan.ashton.fashion/api/goods/30/comments';\n\nconst main = document.createElement('div');\nconst form = new _components_form_FormComponent_js__WEBPACK_IMPORTED_MODULE_0__.Form();\nconst commentsList = new _components_CommentsList_js__WEBPACK_IMPORTED_MODULE_1__.CommentsList();\nconst showMoreButton = new _components_showMorebutton_ShowMoreButton_js__WEBPACK_IMPORTED_MODULE_2__.ShowMoreButton();\n\ncommentsList.getData(commentsURL);\n\nshowMoreButton.element.addEventListener('click', () => {\n    if(localStorage.nextPageUrl){\n        commentsList.getData(localStorage.nextPageUrl);\n    } else { \n        showMoreButton.element.disabled = true;\n    }\n})\n\nform.render();\ncommentsList.render();\nshowMoreButton.render();\n\nmain.className = 'main';\nmain.appendChild(form.element);\nmain.appendChild(commentsList.element);\nmain.appendChild(showMoreButton.element);\n\ndocument.body.appendChild(main);\n\n//# sourceURL=webpack://-webhome/./src/index.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/components/form/FormComponent.js");
/******/ 	
/******/ })()
;